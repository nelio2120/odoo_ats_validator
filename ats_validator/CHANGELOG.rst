...
18.0.1.0.0 (2026-06-23)
------------------------

- Primera versión del módulo: subida de XML del ATS, validación contra el
  microservicio externo, visualización de errores XSD, errores de negocio,
  advertencias y talón resumen HTML.
